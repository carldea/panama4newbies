...
# Generate SDL2.h to java bindings // #-I /usr/local/include/SDL2 -l SDL2 \
jextract --output src -t sdl2 \
...
# Generate foo.h to java bindings
...
javac -cp .:classes -d classes src/sdl2/*.java src/org/**/*.java src/*.java